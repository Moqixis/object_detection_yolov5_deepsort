...
def parse_opt(known=False):
    ...
    # 修改路径
    parser.add_argument('--weights', type=str, default='/data/anhui-ai/lhq/yolov5/runs/train/exp/weights/best.pt', help='initial weights path')
    ...
    # 修改路径
    parser.add_argument('--project', default='/data/anhui-ai/lhq/yolov5/runs/train', help='save to project/name')
