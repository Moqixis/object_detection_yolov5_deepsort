...
def parse_opt():
    ...
    # 修改模型路径 yolov5_n
    parser.add_argument('--weights', nargs='+', type=str, default='/data/dataset/lhq/test3/runs/train/exp4/weights/best.pt', help='model path(s)') # 修改
    # 修改数据路径
    # parser.add_argument('--source', tye=str, default=ROOT / 'data/images', help='file/dir/URL/glob, 0 for webcam') # 修改
    parser.add_argument('--source', type=str, default='/data/dataset/lhq/test/video', help='file/dir/URL/glob, 0 for webcam') # 修改
