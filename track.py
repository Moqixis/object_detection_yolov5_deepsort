...
from yolov5.utils.general import (LOGGER, check_file, check_img_size, non_max_suppression, scale_coords, check_requirements, cv2,
...
def parse_opt():
    ...
    # parser.add_argument('--source', type=str, default='/home/lihuiqian/mycode/test5/yolov5/data/images', help='file/dir/URL/glob, 0 for webcam')  
    ...
    # 修改保存路径
    parser.add_argument('--project', default='/data/anhui-ai/lhq/yolov5/runs/track', help='save results to project/name')
